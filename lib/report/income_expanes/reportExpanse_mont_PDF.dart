...
class report_expane_mont_PDF {
  static Save_expanes_Mont_PDF(report_incomeNotifire Mont, contex) async {
        ...
        build: (pw.Context context) {
          return pw.Container(
            ...
            child: pw.Column(
              ...
              children: [
                pw.Text(
                  'ລາຍງານລາຍຈ່າຍປະຈຳປີ : ${DateTime.now().year}',
                  style: pw.TextStyle(
                ...
                pw.Center(
                  child: pw.Text(
                    'ລາຍລະອຽດ ລາຍຈ່າຍ ຮ້ານຂາຍເຄື່ອງສຳອາງອອນລາຍ',
                    style: pw.TextStyle(
                        fontSize: 16,
                        fontWeight: pw.FontWeight.bold,
                        font: ttf),
                ...
                pw.Row(
                    ...
                    children: [
                      pw.Text(
                          'ລວມເງີນລາຍຈ່າຍທັ້ງໝົດ :  ${NumberFormat.decimalPattern().format(Mont.Sumtotal)} ກິບ',
                          style: pw.TextStyle(
                              fontSize: 16,
                              fontWeight: pw.FontWeight.bold,
                              font: ttf)),
  ...
  static pw.ListView listView(report_incomeNotifire Mont, pw.Font ttf) {
    return pw.ListView.builder(
      itemCount: Mont.expanese.length,
          ...
          pw.Row(
              ...
              children: [
                ...
                pw.SizedBox(
                  width: 60,
                  child: pw.Text(
                    'ເດືອນທີ່: ${Mont.expanese[index].date!.toDate().toString().substring(6, 7)}',
                    style: pw.TextStyle(
                        fontSize: 12,
                        fontWeight: pw.FontWeight.bold,
                        font: ttf),
                ...
                pw.SizedBox(
                  width: 60,
                  child: pw.Text(
                    '${NumberFormat.decimalPattern().format(Mont.expanese[index].sumtatall)}',
                    style: pw.TextStyle(
                        fontSize: 12,
                        fontWeight: pw.FontWeight.bold,
                        font: ttf),
          ...
          return pw.Container(
            ...
            child: pw.Column(
              ...
              children: [
                ...
                pw.Center(
                  child: pw.Text(
                    'ລາຍລະອຽດ ລາຍຈ່າຍປະຈຳເດືອນ ຮ້ານຂາຍເຄື່ອງສຳອາງອອນລາຍ',
                    style: pw.TextStyle(
                        fontSize: 16,
                        fontWeight: pw.FontWeight.bold,
                        font: ttf),
                ...
                pw.Row(
                    ...
                    children: [
                      pw.Text(
                          'ລວມເງີນລາຍຈ່າຍທັ້ງໝົດ :  ${NumberFormat.decimalPattern().format(Day.Sumtotal)} ກິບ',
                          style: pw.TextStyle(
                              fontSize: 16,
                              fontWeight: pw.FontWeight.bold,
                              font: ttf)),
