...
class PurchaseProductPDF {
  static SavePurchaseProductPDF(SupplierNotifire importProduct, context) async {
        ...
        build: (pw.Context context) {
          return pw.Container(
            ...
            child: pw.Column(
              children: [
                pw.Text(
                  'ລາຍງານການສັ່ງຊື້ສິນຄ້າເຂົ້າຮ້ານ',
                  style: pw.TextStyle(
                ...
                pw.Center(
                  child: pw.Text(
                    'ລາຍລະອຽດຂອງການສັ່ງຊື້ສິນຄ້າເຂົ້າຮ້ານ',
                    style: pw.TextStyle(
                        fontSize: 18,
                        fontWeight: pw.FontWeight.bold,
                        font: ttf),
